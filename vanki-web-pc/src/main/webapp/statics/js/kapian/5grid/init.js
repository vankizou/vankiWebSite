...
(function (jQuery, h, c) {
    var a = jQuery([]), e = jQuery.resize = jQuery.extend(jQuery.resize, {}), i, k = "setTimeout", j = "resize",
...
(function () {
    ...
    jQuery.fn.accelerate_5grid = function () {
        return jQuery(this).css('-webkit-transform', 'translateZ(0)').css('-webkit-backface-visibility', 'hidden').css('-webkit-perspective', '500');
    }
